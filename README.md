# Frontend - Angular 17 Color Prediction UI
...
The app uses Bootstrap 5 CDN and Material Icons. API base assumed at `/api`.

## Pages
- Home: auto carousel
- Register: mobile + OTP flow
- Login: JWT saved to localStorage
- Win: placeholder
- Profile: protected, shows wallet and logout

## Notes
- Add banner images under `src/assets/banners/` named `banner1.jpg`, `banner2.jpg`, `banner3.jpg`.
